...
Begin VB.Form Form3 
   ...
   Begin VB.Timer cpushot 
      Interval        =   500
      Left            =   5640
      Top             =   3120
   End
   Begin VB.Timer cpumove 
      Enabled         =   0   'False
      Interval        =   75
      Left            =   5880
      Top             =   2040
...
Private Sub cpumove_Timer()
If p1.Top < p2.Top Then
p2.Top = p2.Top - 120
ElseIf p1.Top > p2.Top Then
p2.Top = p2.Top + 120
ElseIf p1.Top = p1.Top Then
p2.Top = p2.Top
End If
End Sub

Private Sub cpushot_Timer()
If Label4.caption = "0" Then
cpumove.Enabled = False
p2.Top = 3720
Pause 3
cpumove.Enabled = True
Else
End If
If p2.Top = p1.Top + 480 Then
